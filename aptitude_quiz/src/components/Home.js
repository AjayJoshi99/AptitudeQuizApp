    ...
    <div className="homeDiv">
      ...
      <div className='childDiv' style={{ backgroundImage: "url('bg1.png')", backgroundRepeat: 'no-repeat',backgroundSize: '100% 100%' }}>
        ...
        <ul>
          ...
          <li><NavLink to='/Exam/14'><button className='btn text-primary'>Time and Distance </button></NavLink></li>
          <li><NavLink to='/Exam/15'><button className='btn text-primary'>Area</button></NavLink></li>
          <li><NavLink to='/Exam/13'><button className='btn text-primary'>Clock</button></NavLink></li>
      ...
      <div className='childDiv' style={{ backgroundImage: "url('bg4.png')", backgroundRepeat: 'no-repeat',backgroundSize: '100% 100%' }}>
        ...
        <ul>
          <li><NavLink to='/Exam/7'><button className='btn text-primary'>Blood Relation - I</button></NavLink></li>
          <li><NavLink to='/Exam/8'><button className='btn text-primary'>Direction and Sences </button></NavLink></li>
          <li><NavLink to='/Exam/9'><button className='btn text-primary'>Find the Odd</button></NavLink></li>
          <li><NavLink to='/Exam/10'><button className='btn text-primary'>Classification</button></NavLink></li>
